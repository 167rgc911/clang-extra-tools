...
/* Binding for "root": */
/* CXXDeleteExpr 0x562ae1b3aeb8 </home/rgc/t/clang-ast/t.cpp:22:3, col:11>
 * 'void' Function 0x562ae1b36560 'operator delete' 'void (void *) noexcept' */
/* `-ImplicitCastExpr 0x562ae1b3aea0 <col:10, col:11> 'int *' <LValueToRValue>
 */
/*   `-UnaryOperator 0x562ae1b3ae88 <col:10, col:11> 'int *' lvalue prefix '*'
 * cannot overflow */
/*     `-ImplicitCastExpr 0x562ae1b3ae70 <col:11> 'int **' <LValueToRValue> */
/*       `-DeclRefExpr 0x562ae1b3ae50 <col:11> 'int **' lvalue Var
 * 0x562ae1b3ad68 'pp' 'int **' */

/* Binding for "varName": */
/* DeclRefExpr 0x562ae1b3ae50 </home/rgc/t/clang-ast/t.cpp:22:11> 'int **'
 * lvalue Var 0x562ae1b3ad68 'pp' 'int **' */
...
public:
  ...
  run (const MatchFinder::MatchResult &Result)
  {
    if (const auto *delete_stmt
        = Result.Nodes.getNodeAs<DeclRefExpr> ("varName"))
      {
        const auto *valueDecl = delete_stmt->getDecl ();
        llvm::outs () << "Variable name used in delete: "
                      << valueDecl->getNameAsString () << "\n";
      }
  }
};

/* m binaryOperator(hasOperatorName("=="),
 * hasRHS(hasDescendant(declRefExpr(to(varDecl(hasName("pp"))))))) */
/* Binding for "root": */
/* BinaryOperator 0x562ae1b3afa0 </home/rgc/t/clang-ast/t.cpp:23:7, col:14>
 * 'bool' '==' */
/* |-UnaryOperator 0x562ae1b3aef8 <col:7, col:8> 'int *' prefix '&' cannot
 * overflow */
/* | `-DeclRefExpr 0x562ae1b3aed8 <col:8> 'int' lvalue Var 0x562ae1b1b6f0 'x'
 * 'int' */
/* `-ImplicitCastExpr 0x562ae1b3af88 <col:13, col:14> 'int *' <LValueToRValue>
 */
/*   `-UnaryOperator 0x562ae1b3af70 <col:13, col:14> 'int *' lvalue prefix '*'
 * cannot overflow */
/*     `-ImplicitCastExpr 0x562ae1b3af58 <col:14> 'int **' <LValueToRValue> */
/*       `-DeclRefExpr 0x562ae1b3af38 <col:14> 'int **' lvalue Var
 * 0x562ae1b3ad68 'pp' 'int **' */

/* m ifStmt(hasCondition(expr(binaryOperator(hasOperatorName("=="),
 * hasRHS(hasDescendant(declRefExpr())))))) */
/* m ifStmt(hasCondition(expr(binaryOperator(hasOperatorName("=="),
 * hasRHS(hasDescendant(declRefExpr().bind("var"))))))) */
/* Match #1: */
...
StatementMatcher IfMatcher = ifStmt (hasCondition (expr (binaryOperator (
    hasOperatorName ("=="),
    hasRHS (hasDescendant (declRefExpr ().bind ("varName")))))));
    ...
    if (const auto *if_stmt = Result.Nodes.getNodeAs<DeclRefExpr> ("varName"))
      {
        ...
        llvm::outs () << "Variable name used in if comparision: "
                      << valueDecl->getNameAsString () << "\n";
      }
  }
};
